...
export default function Panchakarma() {
  const therapies = [
    {
      title: "Virechan",
      desc: "Purgation therapy for deep detoxification.",
      icon: Flame,
    },
    {
      title: "Basti",
      desc: "Medicated enema for chronic issues & gut balance.",
      icon: Droplet,
    },
    {
      title: "Nasya",
      desc: "Nasal cleansing for sinus, migraine & mental clarity.",
      icon: Wind,
    },
    {
      title: "Shirodhara",
      desc: "Warm herbal oil dripping for stress & insomnia relief.",
      icon: Leaf,
    },
    {
      title: "Potli Massage",
      desc: "Herbal pouch therapy for joint & muscle pain.",
      icon: HandHeart,
    },
    {
      title: "Udwarthanam",
      desc: "Dry herbal powder massage for fat reduction & skin glow.",
      icon: Sparkles,
    },
    {
      title: "Herbal Steam Bath",
      desc: "Sweating therapy for detox & muscle relaxation.",
      icon: ThermometerSun,
    },
    {
      title: "Abhyanga",
      desc: "Full body warm oil massage for rejuvenation.",
      icon: Waves,
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-20 pb-28">
          <div className="lg:w-3/5">
            ...
            <p className="text-lg text-slate-600 mt-4">
              Detoxification & rejuvenation therapies for better health.
            </p>
          </div>
        </div>
      ...
      <section className="bg-white pt-10 pb-20">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <h2 className="text-xl sm:text-2xl font-semibold text-[#759c7c] flex items-center gap-2 mb-8 sm:mb-10">
            <Droplet className="text-[#759c7c]" size={26} />
